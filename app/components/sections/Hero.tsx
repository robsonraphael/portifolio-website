...
const whatsappUrl =
  'https://api.whatsapp.com/send?phone=5581993873682&text=Olá%2C%20Robson!%20Quero%20saber%20mais%20sobre%20seus%20serviços.'
    ...
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[var(--bg-overlay)] via-[var(--bg-base)] to-[var(--bg-surface)] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10 pt-20">
        <h1 className="display-title text-4xl md:text-6xl mb-6 leading-tight">
          Tecnologia que trabalha enquanto você foca no seu negócio.
        </h1>

        <p className="text-lg md:text-2xl body-text mb-8 max-w-4xl mx-auto">
          Desenvolvo sites profissionais, automação de atendimento e sistemas sob medida para negócios que querem crescer com tecnologia de verdade.
