    ...
    <section id="services" className="py-20 bg-bg-base">
      <div className="container mx-auto px-6">
        <div className="text-center mb-14">
          <h2 className="text-3xl md:text-4xl font-display text-text-primary">O que eu desenvolvo para escritórios de advocacia</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          {services.map((service) => (
            <div key={service.title} className="card">
              ...
              <h3 className="text-xl text-text-primary font-semibold mb-3">{service.title}</h3>
